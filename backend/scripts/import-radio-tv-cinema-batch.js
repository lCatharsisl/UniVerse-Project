...
const DEPARTMENT_ID = 19; // Radyo, Televizyon ve Sinema

const staffBatch = [
  { fullName: 'Mahmut Çağrı İnceoğlu', title: 'Doç.Dr.', phone: '0232-570 8429' },
  { fullName: 'Nazlı Bayram', title: 'Prof.Dr.', phone: '0232-570 8421' },
  { fullName: 'Melek Atabey', title: 'Doç.Dr.', phone: '0232-570 8443' },
  { fullName: 'Gizem Melek', title: 'Doç.Dr.', phone: '0232-570 8445' },
  { fullName: 'Ürün Yıldıran Önk', title: 'Doç.Dr.', phone: '0232-570 8430' },
  { fullName: 'Burcu Dabak Özdemir', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8449' },
  { fullName: 'Güven Selçuk', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8446' },
  { fullName: 'İlayda Muhtar', title: 'Araş.Gör.', phone: '0232-570 8475' },
  { fullName: 'Baha Tan Oral', title: 'Araş.Gör.', phone: '0232-570 8476' },
  { fullName: 'Hasan Işıklı', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Öykü Yenen Aytekin', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Tayfun Bilgin', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Berk Tuğcu', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Ayşe Kanıt', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Yasin Güven Zararsız', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Nitsa Çukurel Kapancıoğu', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Alper Turkkan', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of dedupedBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.rtv@yasar.edu.tr`.replace(/\.\./g, '.');
