...
const DEPARTMENT_ID = 15; // İngiliz Dili ve Edebiyatı

const staffBatch = [
  { fullName: 'Esen Kara Göktoğan', title: 'Assist.Prof. (PhD)', phone: '0232-570 8830' },
  { fullName: 'Mustafa Ahmet Süner', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8853' },
  { fullName: 'Evren Akaltun Akan', title: 'Assist.Prof. (PhD)', phone: '0232-570 8855' },
  { fullName: 'Ayşegül Avcı', title: 'Assist.Prof. (PhD)', phone: '0232-570 8861' },
  { fullName: 'Jeffrey D. Hibbert', title: 'Assist.Prof. (PhD)', phone: '0232-570 8852' },
  { fullName: 'Can Özgü', title: 'Assist.Prof. (PhD)', phone: '0232-570 8859' },
  { fullName: 'Çağrı Özköse Bıyık', title: 'Assist.Prof. (PhD)', phone: '0232-570 8842' },
  { fullName: 'Jason Mark Ward', title: 'Assist.Prof. (PhD)', phone: '0232-570 8854' },
  { fullName: 'Naz Defne Adal', title: 'Research Assistant', phone: '0232-570 8884' },
  { fullName: 'Evrim Işık', title: 'Research Assistant', phone: '0232-570 8871' },
  { fullName: 'Hatice İclal Kardıçalı', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.ell@yasar.edu.tr`.replace(/\.\./g, '.');
