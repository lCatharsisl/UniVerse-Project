...
const DEPARTMENT_ID = 11; // Uluslararası Ticaret ve Finansman

const staffBatch = [
  { fullName: 'Fatma Dilvin Taşkın Yeşilova', title: 'Prof. (PhD)', phone: '0232-570 8934' },
  { fullName: 'Hasan Fehmi Baklacı', title: 'Prof. (PhD)', phone: '0232-570 8917' },
  { fullName: 'Ebru Esendemirli', title: 'Prof. (PhD)', phone: '0232-570 8955' },
  { fullName: 'Mehmet Oğuz Karahan', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8928' },
  { fullName: 'Esra Alp Çoşkun', title: 'Assist.Prof. (PhD)', phone: '0232-570 8942' },
  { fullName: 'Barış Serkan Kopurlu', title: 'Lecturer (PhD)', phone: '0232-570 8940' },
  { fullName: 'Senem Sönmez Selçuk', title: 'Lecturer (PhD)', phone: '0232-570 8638' },
  { fullName: 'Yiğit Gökmen Etik', title: 'Research Assistant', phone: '0232-570 8983' },
  { fullName: 'Merve Keser', title: 'Research Assistant', phone: '0232-570 8985' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.itf@yasar.edu.tr`.replace(/\.\./g, '.');
