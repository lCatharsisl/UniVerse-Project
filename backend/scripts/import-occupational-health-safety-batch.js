...
const DEPARTMENT_ID = 39; // İş Sağlığı ve Güvenliği

const staffBatch = [
  { fullName: 'Oğuz Gora', title: 'Assist.Prof. (PhD)', phone: '0232-570 8628' },
  ...
  { fullName: 'Selen Çekinir', title: 'Assist.Prof. (PhD)', phone: '0232-570 8625' },
  { fullName: 'Aşkın Demirci', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Murat Diker', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'İsmail Can Ataş', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.ohs@yasar.edu.tr`.replace(/\.\./g, '.');
