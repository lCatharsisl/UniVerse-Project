...
const DEPARTMENT_ID = 45; // Deniz ve Liman İşletmeciliği

const staffBatch = [
  { fullName: 'Kadriye Oya Turhaner', title: 'Lecturer (PhD)', phone: '0232-570 8645' },
  { fullName: 'Zeynep Tunca Özcan', title: 'Assist.Prof. (PhD)', phone: '0232-570 8557' },
  { fullName: 'Ayşe Hanife Kocakaya', title: 'Lecturer (PhD)', phone: '0232-570 8627' },
  { fullName: 'Görkem Akgül', title: 'Lecturer (PhD)', phone: '0232-570 8655' },
  { fullName: 'Mehmet Tunç', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Ahmet Neşet Erensoy', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Mihri Çelik', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Sena Musa Parıldar', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Zeynep Çalık Bürket', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Mesut Baykan', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.mpm@yasar.edu.tr`.replace(/\.\./g, '.');
