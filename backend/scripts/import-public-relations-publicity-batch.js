...
const DEPARTMENT_ID = 43; // Halkla İlişkiler ve Tanıtım (Public Relations and Publicity)

const staffBatch = [
  { fullName: 'İrem Begüm Paker', title: 'Assist.Prof. (PhD)', phone: '0232-570 8644' },
  ...
  { fullName: 'Ece İpekoğlu', title: 'Assist.Prof. (PhD)', phone: '0232-570 8634' },
  { fullName: 'Sezer Deniz Türsen', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Mükerrem Özlem Acar', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Deniz Dünyaoğulları Hünler', title: 'Öğrt. Gör.', phone: null },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.prp@yasar.edu.tr`.replace(/\.\./g, '.');
