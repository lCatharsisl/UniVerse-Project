...
const DEPARTMENT_ID = 9; // İşletme

const staffBatch = [
  { fullName: 'Görkem Ataman', title: 'Prof. (PhD)', phone: '0232-570 8951' },
  { fullName: 'Aylin Çalışkan', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8981' },
  { fullName: 'Osman Gök', title: 'Prof. (PhD)', phone: '0232-570 8933' },
  { fullName: 'Duygu Türker Özmen', title: 'Prof. (PhD)', phone: '0232-570 8932' },
  { fullName: 'Özge Can', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8949' },
  { fullName: 'Ömer Öztürkoğlu', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8950' },
  { fullName: 'Özen Ece Acar', title: 'Assist.Prof. (PhD)', phone: '0232-570 8948' },
  { fullName: 'Mert Sarıoğlu', title: 'Assist.Prof. (PhD)', phone: '0232-570 8945' },
  { fullName: 'Mürüvvet Deniz Sezer', title: 'Assist.Prof. (PhD)', phone: '0232-570 8978' },
  { fullName: 'Gizem Kurt', title: 'Lecturer (PhD)', phone: '0232-570 8937' },
  { fullName: 'Hüseyin Ozan Altın', title: 'Research Assistant', phone: '0232-570 8954' },
  { fullName: 'Mehmet Teoman Köktürk', title: 'Research Assistant', phone: '0232-570 8956' },
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.bus@yasar.edu.tr`.replace(/\.\./g, '.');
