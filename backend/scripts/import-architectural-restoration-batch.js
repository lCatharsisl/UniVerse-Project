...
const DEPARTMENT_ID = 37; // Mimari Restorasyon

const staffBatch = [
  { fullName: 'Nağme Ebru Karabağ', title: 'Assist.Prof. (PhD)', phone: '0232-570 8132' },
  { fullName: 'Nazlı İpek Mavuşoğlu', title: 'Lecturer', phone: '0232-570 8147' },
  { fullName: 'Ecehan Özmehmet', title: 'Assist.Prof. (PhD)', phone: '0232-570 8130' },
  { fullName: 'Zübeyda Önlü', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Mahir Kaplan', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Taner Çetinel', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Seda Öztekin', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Begüm Cansu Aydın Koç', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'İdil Ece Şener', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Ahu Sönmez', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.mrest@yasar.edu.tr`.replace(/\.\./g, '.');
