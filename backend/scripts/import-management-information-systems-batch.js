...
const DEPARTMENT_ID = 32; // Yönetim Bilişim Sistemleri (MIS)

const staffBatch = [
  { fullName: 'Ahmet Tuncay Ercan', title: 'Prof.Dr.', phone: '0232-570 8241' },
  { fullName: 'Ahmet Nuri Başoğlu', title: 'Prof. (PhD)', phone: '0232-570 7868' },
  { fullName: 'Murat Komesli', title: 'Prof. (PhD)', phone: '0232-570 7865' },
  { fullName: 'Enes Kademi', title: 'Assist.Prof. (PhD)', phone: '0232-570 8358' },
  { fullName: 'Mahir Kutay', title: 'Dr. Öğr. Üyesi', phone: '0232-570 8262' },
  { fullName: 'Şelale Ersevinç', title: 'Research Assistant', phone: '0232-570 7867' },
  { fullName: 'Kaan Özyazıcı', title: 'Research Assistant', phone: '0232-570 7862' },
  { fullName: 'Ecem İren', title: 'Dr. Öğr. Üyesi', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.mis@yasar.edu.tr`.replace(/\.\./g, '.');
