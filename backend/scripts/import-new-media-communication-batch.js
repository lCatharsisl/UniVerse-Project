...
const DEPARTMENT_ID = 20; // Yeni Medya ve İletişim

const staffBatch = [
  { fullName: 'Özlem Ozan Özarslan', title: 'Doç.Dr.', phone: '0232-570 8431' },
  { fullName: 'Sevda Alankuş', title: 'Prof.Dr.', phone: '0232-570 8400' },
  { fullName: 'Gizem Kızıltunalı Sonyol', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8127' },
  { fullName: 'Mert Seven', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8468' },
  { fullName: 'Simge Gökbayrak Yelken', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8448' },
  { fullName: 'Nazlı Zeynep Kaptı', title: 'Araş.Gör.', phone: '0232-570 8469' },
  { fullName: 'Huriye Toker', title: 'Prof.Dr.', phone: '0232-570 8440' },
  ...
  { fullName: 'Mehmet Arif Koşar', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Ayça Durmaz Taşçı', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Can Fakıoğlu', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Sezer Deniz Türsen', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of dedupedBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.nmc@yasar.edu.tr`.replace(/\.\./g, '.');
