...
const DEPARTMENT_ID = 16; // İngilizce Mütercim ve Tercümanlık

const staffBatch = [
  { fullName: 'Özge Altıntaş', title: 'Assist.Prof. (PhD)', phone: '0232-570 8857' },
  { fullName: 'Trevor John Hope', title: 'Assist.Prof. (PhD)', phone: '0232-570 8840' },
  { fullName: 'Asiye Öztürk', title: 'Assist.Prof. (PhD)', phone: '0232-570 8860' },
  { fullName: 'Aslı Davaz', title: 'Lecturer (PhD)', phone: '0232-570 8833' },
  { fullName: 'Ufuk Özbir', title: 'Lecturer', phone: '0232-570 8834' },
  { fullName: 'Emre Canbaz', title: 'Research Assistant', phone: '0232-570 8872' },
  { fullName: 'Ömer Mert Kılıç', title: 'Research Assistant', phone: '0232-570 8883' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.eti@yasar.edu.tr`.replace(/\.\./g, '.');
