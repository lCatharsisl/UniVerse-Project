...
const DEPARTMENT_ID = 18; // Halkla İlişkiler ve Reklamcılık

const staffBatch = [
  { fullName: 'Ebru Gökaliler', title: 'Prof.(PhD)', phone: '0232-570 8428' },
  { fullName: 'Özlem Alikılıç', title: 'Prof. (PhD)', phone: '0232-570 8442' },
  { fullName: 'Huriye Toker', title: 'Prof. (PhD)', phone: '0232-570 8440' },
  { fullName: 'Ferah Onat', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8441' },
  { fullName: 'Dilek Melike Uluçay', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8637' },
  { fullName: 'Asuman Özer', title: 'Research Assistant (PhD)', phone: '0232-570 8472' },
  { fullName: 'Simge Uğurluer', title: 'Research Assistant (PhD)', phone: '0232-570 8462' },
  { fullName: 'Güven Selçuk', title: 'Lecturer (PhD)', phone: '0232-570 8446' },
  { fullName: 'Cudi Kaan Okmeydan', title: 'Assist.Prof. (PhD)', phone: '0232-570 8463' },
  { fullName: 'Simge Gökbayrak Yelken', title: 'Lecturer (PhD)', phone: '0232-570 8448' },
  { fullName: 'Maria Jose Cabezas Correa', title: 'Lecturer', phone: '0232-570 8777' },
  { fullName: 'Türkan Hande Arbak', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Can Zibil', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.pra@yasar.edu.tr`.replace(/\.\./g, '.');
