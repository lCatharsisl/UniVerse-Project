...
const DEPARTMENT_ID = 6; // İnşaat Mühendisliği

const staffBatch = [
  { fullName: 'Oğuz Özgür Eğilmez', title: 'Prof. (PhD)', phone: '0232-570 8227' },
  { fullName: 'Süleyman İpek', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8267' },
  { fullName: 'Jafar Safari', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8269' },
  { fullName: 'Burak Akbaş', title: 'Assist.Prof. (PhD)', phone: '0232-570 8286' },
  { fullName: 'Şahin Çağlar Tuna', title: 'Assist.Prof. (PhD)', phone: '0232-570 8273' },
  { fullName: 'Kutay Yılmaz', title: 'Assist.Prof. (PhD)', phone: '0232-570 8272' },
  { fullName: 'Saadettin Akman', title: 'Research Assistant', phone: '0232-570 8283' },
  { fullName: 'Denizhan Mersin', title: 'Research Assistant', phone: '0232-570 8365' },
  { fullName: 'Mert Araz', title: 'Construction Technician', phone: '0232-570 8394' },
  { fullName: 'Şahlar Meherrem', title: 'Prof. (PhD)', phone: '0232-570 9235' },
  { fullName: 'Cahit Helvacı', title: 'Prof.Dr.', phone: '0232-570-7070' },
  { fullName: 'Ali Mert Ceylan', title: 'Assist. Prof.(Phd)', phone: '0232-570 8369' },
  { fullName: 'Efthymia Staiou', title: 'Assist.Prof. (PhD)', phone: '0232-570 8264' },
  { fullName: 'Emin Selahattin Umdu', title: 'Assist.Prof. (PhD)', phone: '0232-570 8271' },
  { fullName: 'Mauricio Gabriel Morales Beltran', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8145' },
  { fullName: 'Aylin Bedriye Atacan', title: 'Lecturer', phone: '0232-570 9800' },
  { fullName: 'Nejla Gündoğar', title: 'Lecturer', phone: '0232-570 7488' },
];
...
async function run() {
  ...
  for (const person of dedupedBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.civil@yasar.edu.tr`.replace(/\.\./g, '.');
