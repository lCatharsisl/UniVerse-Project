...
const DEPARTMENT_ID = 42; // Lojistik (MYO)

const staffBatch = [
  { fullName: 'İkbal Ece Dizbay', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8639' },
  { fullName: 'Yeliz Demirkıran', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8641' },
  { fullName: 'Feride Deniz Zaptcıoğlu Çelikde', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8630' },
  { fullName: 'Görkem Akgül', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8655' },
  { fullName: 'Levent Özkardeş', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Aslı Malay Tuncer', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Turhan Tuncalı', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.log@yasar.edu.tr`.replace(/\.\./g, '.');
