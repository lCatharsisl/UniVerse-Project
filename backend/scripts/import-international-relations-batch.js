...
const DEPARTMENT_ID = 14; // Uluslararası İlişkiler

const staffBatch = [
  { fullName: 'Elif Çetin', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8841' },
  { fullName: 'Mehmet Gökay Özerim', title: 'Prof. (PhD)', phone: '0232-570 7452' },
  { fullName: 'Aylin Güney Gevrek', title: 'Prof. (PhD)', phone: '0232-570 7101' },
  { fullName: 'Emre İşeri', title: 'Prof. (PhD)', phone: '0232-570 8837' },
  { fullName: 'Defne Günay Ulubay', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8849' },
  { fullName: 'Dilaver Arıkan Açar', title: 'Assist.Prof. (PhD)', phone: '0232-570 8850' },
  { fullName: 'Zahide Melis Özün Çöllüoğlu', title: 'Research Assistant (PhD)', phone: '0232-570 8873' },
  { fullName: 'Özge Bozkaya', title: 'Research Assistant', phone: '0232-570 8879' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.uir@yasar.edu.tr`.replace(/\.\./g, '.');
