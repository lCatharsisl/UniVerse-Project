...
const DEPARTMENT_ID = 5; // Enerji Sistemleri Mühendisliği

const staffBatch = [
  { fullName: 'Arif Hepbaşlı', title: 'Prof.Dr.', phone: '0232-570 8222' },
  { fullName: 'Emrah Bıyık', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8250' },
  { fullName: 'Selen Çekinir', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8625' },
  { fullName: 'Emin Selahattin Umdu', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8271' },
  { fullName: 'Levent Bilir', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8249' },
  { fullName: 'Nezir Yağız Çam', title: 'Araş.Gör.Dr.', phone: '0232-570 8355' },
  { fullName: 'Şadiye Birce Bakan', title: 'Araş.Gör.', phone: '0232-570 8288' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.es@yasar.edu.tr`.replace(/\.\./g, '.');
