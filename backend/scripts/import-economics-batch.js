...
const DEPARTMENT_ID = 8; // Ekonomi

const staffBatch = [
  { fullName: 'Durmuş Özdemir', title: 'Prof. (PhD)', phone: '0232-570 8920' },
  { fullName: 'Umut Halaç', title: 'Prof.Dr.', phone: '0232-570 8930' },
  { fullName: 'Serpil Kaçmaz', title: 'Prof. (PhD)', phone: '0232-570 8952' },
  { fullName: 'Ayşe Özden Birkan', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8941' },
  { fullName: 'Ali Onur Peker', title: 'Research Assistant (PhD)', phone: '0232-570 8988' },
  { fullName: 'Aykut Lenger', title: 'Prof.Dr.', phone: '0232-570-7070' },
  { fullName: 'Meneviş Uzbay Pirili', title: 'Doç.Dr.', phone: '0232-570-7070' },
  { fullName: 'Tuğçe Uygurtürk Gazel', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.eco@yasar.edu.tr`.replace(/\.\./g, '.');
