...
const DEPARTMENT_ID = 41; // Dış Ticaret

const staffBatch = [
  { fullName: 'Yeliz Demirkıran', title: 'Assist.Prof. (PhD)', phone: '0232-570 8641' },
  { fullName: 'Seher Gören Yargı', title: 'Assist.Prof. (PhD)', phone: '0232-570 8980' },
  { fullName: 'Ece İpekoğlu', title: 'Assist.Prof. (PhD)', phone: '0232-570 8634' },
  { fullName: 'Levent Özkardeş', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Ümit Kaya', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Bengü Yardımcı', title: 'Assist.Prof. (PhD)', phone: '0232-570 8651' },
  { fullName: 'Damla Nurcan Özkılınç', title: 'Lecturer (PhD)', phone: '0232-570 8936' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.ft@yasar.edu.tr`.replace(/\.\./g, '.');
