...
const DEPARTMENT_ID = 10; // Lojistik Yönetimi

const staffBatch = [
  { fullName: 'Pervin Ersoy Ataç', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8939' },
  { fullName: 'Yiğit Kazançoğlu', title: 'Prof. (PhD)', phone: '0232-570 7101' },
  { fullName: 'Yücel Öztürkoğlu', title: 'Prof. (PhD)', phone: '0232-570 9021' },
  { fullName: 'Gülmüş Börühan Karaca', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8938' },
  { fullName: 'Yeşim Deniz Özkan Özen', title: 'Assist.Prof. (PhD)', phone: '0232-570 8984' },
  { fullName: 'Melisa Özbiltekin Pala', title: 'Assist.Prof. (PhD)', phone: '0232-570 8172' },
  { fullName: 'Burak Çetiner', title: 'Research Assistant', phone: '0232-570 8977' },
  { fullName: 'İpek Doğa Bedirhan', title: 'Research Assistant', phone: '0232-570 8976' },
  { fullName: 'Yavuz Gazibey', title: 'Dr. Öğr. Üyesi', phone: '0232-570-7070' },
  { fullName: 'Ourania Areta Hızıroğlu', title: 'Dr. Öğr. Üyesi', phone: '0232-570-7070' },
  { fullName: 'Özlem Koçtaş Çotur', title: 'Dr. Öğr. Üyesi', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.lmgt@yasar.edu.tr`.replace(/\.\./g, '.');
