...
import { FiGlobe, FiCloud } from 'react-icons/fi';
...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  return (
    <div className={`min-h-screen selection:bg-primary selection:text-white transition-colors duration-700 ${isSpace ? 'bg-[#050510] text-[#e1e1e6]' : 'bg-white text-uv-black'}`}>
      ...
      <div className={`${isMap ? 'max-w-[1600px]' : 'max-w-7xl'} mx-auto flex justify-center relative z-10 w-full`}>
        {/* Navigation Column */}
        ...
        {!isMap && <div className="flex-grow hidden lg:block w-[80px] xl:w-[280px]"></div>}
