...
const DEPARTMENT_ID = 35; // Bilgisayar Destekli Tasarım ve Animasyon

const staffBatch = [
  { fullName: 'Hakan Dalkılıç', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8640' },
  { fullName: 'Nazlı Benlioğlu', title: 'Doç.', phone: '0232-570 8737' },
  { fullName: 'Sarp Selçuk', title: 'Öğrt.Gör.', phone: '0232-570 8770' },
  { fullName: 'Tuğçe Gözde Pelister', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8643' },
  { fullName: 'Ahmet Bircan Oğuz', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Burak Kızılobek', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Cansın Dalak', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Efe Ercan', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Kerem Akman', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Yağız Türk', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Cenk Sönmez', title: 'Medya Merkezi Müdürü', phone: '0232-570 7742' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.cada@yasar.edu.tr`.replace(/\.\./g, '.');
