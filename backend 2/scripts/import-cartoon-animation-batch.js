...
const DEPARTMENT_ID = 24; // Çizgi Film ve Animasyon

const staffBatch = [
  { fullName: 'Sevcan Sönmez', title: 'Doç.Dr.', phone: '0232-570 8735' },
  { fullName: 'Ahmet Şefik Güngör', title: 'Prof.Dr.', phone: '0232-570 8721' },
  { fullName: 'Lale Dilbaş', title: 'Prof.Dr.', phone: '0232-570 8717' },
  { fullName: 'Dilara Balcı', title: 'Doç.Dr.', phone: '0232-570 8773' },
  { fullName: 'Umut Altıntaş', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8775' },
  { fullName: 'Sarp Selçuk', title: 'Öğrt.Gör.', phone: '0232-570 8770' },
  { fullName: 'Maria Jose Cabezas Correa', title: 'Öğrt.Gör.', phone: '0232-570 8777' },
  { fullName: 'Asadul Islam', title: 'Öğrt.Gör.', phone: '0232-570 8752' },
  { fullName: 'Sebahat Gökçen Dinçer', title: 'Araş.Gör.', phone: '0232-570 8783' },
  { fullName: 'Emre İhsan Ermiş', title: 'Araş.Gör.', phone: '0232-570 8789' },
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.ca@yasar.edu.tr`.replace(/\.\./g, '.');
