...
const DEPARTMENT_ID = 31; // Turizm Rehberliği

const staffBatch = [
  { fullName: 'Ferika Özer', title: 'Prof. (PhD)', phone: '0232-570 7817' },
  { fullName: 'Orhan İçöz', title: 'Prof. (PhD)', phone: '0232-570 9121' },
  { fullName: 'İge Pırnar', title: 'Prof. (PhD)', phone: '0232-570 9134' },
  { fullName: 'Sinan Ünlüsoy', title: 'Assoc.Prof. (PhD)', phone: '0232-570 9133' },
  { fullName: 'Okay Coşkun', title: 'Research Assistant', phone: '0232-570 7864' },
  { fullName: 'Neslihan Lara Tan', title: 'Research Assistant', phone: '0232-570 7861' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.turg@yasar.edu.tr`.replace(/\.\./g, '.');
