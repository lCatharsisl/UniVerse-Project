...
const DEPARTMENT_ID = 38; // Gıda Teknolojisi

const staffBatch = [
  { fullName: 'Ece Yıldız Öztürk', title: 'Assist.Prof. (PhD)', phone: '0232-570 8648' },
  { fullName: 'Ruhan Aşkın Uzel', title: 'Assoc.Prof. (PhD)', phone: '0232-570 8600' },
  { fullName: 'Sündüs Ünal', title: 'Lecturer (PhD)', phone: '0232-570 8647' },
  { fullName: 'Duygu Tibet Akgül', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.foodtech@yasar.edu.tr`.replace(/\.\./g, '.');
