...
const DEPARTMENT_ID = 46; // Marina ve Yat İşletmeciliği

const staffBatch = [
  { fullName: 'Gizem Kurt', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8937' },
  { fullName: 'Barış Serkan Kopurlu', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8940' },
  { fullName: 'Görkem Akgül', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8655' },
  { fullName: 'Ayşe Hanife Kocakaya', title: 'Dr.Öğrt.Gör.', phone: '0232-570 8627' },
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.myacht@yasar.edu.tr`.replace(/\.\./g, '.');
