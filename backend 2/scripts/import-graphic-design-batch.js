...
const DEPARTMENT_ID = 26; // Grafik Tasarımı (Lisans)

const staffBatch = [
  { fullName: 'Korkut Ünal', title: 'Lecturer', phone: '0232-570 8646' },
  { fullName: 'Tuğçe Gözde Pelister', title: 'Assist.Prof. (PhD)', phone: '0232-570 8643' },
  { fullName: 'Arif Tansel Özalp', title: 'Lecturer', phone: '0232-570 8642' },
  { fullName: 'Kerem Akman', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Ahmet Bircan Oğuz', title: 'Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Mehmet Emin Dinç', title: 'Öğrt. Gör.', phone: null },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.gd@yasar.edu.tr`.replace(/\.\./g, '.');
