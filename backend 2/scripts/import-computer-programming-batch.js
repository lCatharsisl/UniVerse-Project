...
const DEPARTMENT_ID = 34; // Bilgisayar Programcılığı

const staffBatch = [
  { fullName: 'Aslı Güler Serinken', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8632' },
  { fullName: 'Zeynep Yorgancıoğlu', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8633' },
  { fullName: 'Tohid Ahmed Rana', title: 'Öğrt.Gör.', phone: '0232-570 8626' },
  { fullName: 'Hakan Dalkılıç', title: 'Dr.Öğr.Üyesi', phone: '0232-570 8640' },
  { fullName: 'Arif Gürsoy', title: 'Doç.Dr.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const baseEmail = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.cp@yasar.edu.tr`.replace(/\.\./g, '.');
