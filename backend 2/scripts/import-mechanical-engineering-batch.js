...
const DEPARTMENT_ID = 7; // Makine Mühendisliği

const staffBatch = [
  { fullName: 'Mustafa Tutar', title: 'Prof. (PhD)', phone: '0232-570 8287' },
  { fullName: 'Nurdan Yıldırım', title: 'Prof. (PhD)', phone: '0232-570 8251' },
  { fullName: 'Orkun Karabaşoğlu', title: 'Assoc.Prof.(PhD)', phone: '0232-570 8259' },
  { fullName: 'Hüseyin Gökmen Aksoy', title: 'Assist.Prof. (PhD)', phone: '0232-570 8257' },
  { fullName: 'Özgür Kilit', title: 'Assist.Prof. (PhD)', phone: '0232-570 8734' },
  { fullName: 'Efecan Akdal', title: 'Research Assistant', phone: '0232-570 8352' },
  { fullName: 'Serkan Çobanoğlu', title: 'Research Assistant', phone: '0232-570 8362' },
  { fullName: 'Doğan Abukay', title: 'Prof.Dr.', phone: '0232-570-7070' },
  { fullName: 'Cahit Helvacı', title: 'Prof.Dr.', phone: '0232-570-7070' },
  { fullName: 'Öner Haşim Olgun', title: 'Dr. Öğrt. Gör.', phone: '0232-570-7070' },
  { fullName: 'Cem Doğan Şahin', title: 'Araş.Gör.', phone: '0232-570-7070' },
];
...
async function run() {
  ...
  for (const person of staffBatch) {
    ...
    const email = `${toAsciiSlug(name)}.${toAsciiSlug(surname)}.mech@yasar.edu.tr`.replace(/\.\./g, '.');
